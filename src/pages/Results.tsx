    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 mb-4">
          ...
          analysis, supply chain, and urban infrastructure, setting them apart
          in competitive industries.
        </p>
        <p className="text-gray-700">
          <strong>Future Market Opportunity:</strong> The industries represented
          are projected to grow exponentially, with market opportunities ranging
          from $10B in AI-driven market analysis to $1.2T in smart city
